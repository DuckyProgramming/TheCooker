class wall extends partisan{
    ...
    reset(){
        if(this.name!='Blueprint Cabinet'&&this.name!='Upgrade Cabinet'&&this.name!='Discount Cabinet'&&this.name!='Generator Cabinet'&&this.name!='Freezer'&&this.name!='Frozen Prep Station'){
            this.item=-1
        }
        switch(this.name){
